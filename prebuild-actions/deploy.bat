...
echo c:
echo cd\Users\SUUSER\Dropbox\Projects\Eclipse Projects\ontologyLearnerApp\prebuild-action

call rmdir /S /Q D:\Users\SUUSER\.m2\repository\edu\sabanciuniv\dataMining\ontologyLearner
...
call rmdir /S /Q D:\Users\SUUSER\.m2\repository\edu\sabanciuniv\dataMining\opinionMining
call mvn install:install-file -Dfile=opinionMining.jar -DpomFile=opinionMining-pom.xml -Dsources=opinionMining-src.jar

call rmdir /S /Q D:\Users\SUUSER\.m2\repository\org\apache\lucene\lucene-hunspell
