...
public class FELib {
	...
	public Statement get_db_connection(String jdriver, String url,
	...
	// with keywords
	public void parse_input(Statement insert_stmt, String user_input)
			throws SQLException {
		...
		for (int i = 0; i < keyword_lst.length; i++) {
			insert_stmt
					.execute("insert into tripadvisor.extracted_features values ('"
							+ aspect + "', '" + Integer.toString(i) + "')");
		}
	...
	public String[] get_keywords(Statement stmt, String aspect)
			throws SQLException {
