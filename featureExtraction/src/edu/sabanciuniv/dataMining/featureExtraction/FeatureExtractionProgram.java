...
public class FeatureExtractionProgram {
	...
	public FeatureExtractionProgram(FELib lib_fe) throws SQLException {
		this.stmt = stmt;
	...
	public final void createUI() throws SQLException {
		...
		// review_label SPane'in içindeydi ama biz gidip ayrı JPanel'a
		// koymuşuz.
		...
		btn_lst[0].addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				try {
					...
					Logger.getLogger(FeatureExtractionProgram.class.getName())
	...
	public JScrollPane create_review_spane() throws SQLException {
		...
		this.review_label = new JLabel("<html>"
				+ lib_fe.get_next_sample() + "</html>");
	...
	public JScrollPane create_aspect_spane() throws SQLException {
		...
		String aspect_string_list[] = lib_fe.get_aspects();
	...
	public JScrollPane create_keyword_spane() throws SQLException {
		...
		String keyword_string_list[] = lib_fe.get_keywords(this.selected_aspect);
	...
	public void i_add_aspect(ActionEvent event) throws SQLException {
		...
		lib_fe.parse_input(this.aspect_field.getText() + ";"
				+ this.keyword_field.getText());
	...
	public void i_get_next_sample(ActionEvent event) throws SQLException {
		this.review_label.setText("<html>"
				+ lib_fe.get_next_sample()
				+ "</html>");
	...
	public void set_aspect(ListSelectionEvent event) throws SQLException {
		this.selected_aspect = (String) this.aspect_data
				.elementAt(this.aspect_list.getSelectedIndex());
	...
	public static void main(String[] args) throws ClassNotFoundException,
		...
		String url = "jdbc:mysql://localhost/" + FELib.DB_NAME;
		String user_name = "java_user";
		String password = "java_user_pwd";
		FELib lib_fe = new FELib(jdriver, url, user_name, password);

//		Statement stmt = lib_fe.get_db_connection(jdriver, url, user_name,
//				password);
//		Statement insert_stmt = lib_fe.get_db_connection(jdriver, url,
//				user_name, password);
		FeatureExtractionProgram slf = new FeatureExtractionProgram(lib_fe);
	}
}